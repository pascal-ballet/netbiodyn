...
//                                                        System.out.println(re + " - " + instance);
    ...
    public void writeExternal(ObjectOutput out) throws IOException {
        out.writeUTF(this._description.getText());
        out.writeUTF(this.getEtiquettes());
        out.writeObject(this._reactifs);
        out.writeObject(this._produits);
        out.writeDouble(_k);
        out.writeObject(this._positions);
    ...
    public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        _description.setText(in.readUTF());
        setEtiquettes(in.readUTF());
        this._reactifs = (ArrayList) in.readObject();
        this._produits = (ArrayList) in.readObject();
        this._k = in.readDouble();
        this._positions = (ArrayList) in.readObject();
